...
function run_rhf()
  ...
  AOint,dims = juci.ints.get_ints(mol,sett)

  AOops = core(mol,sett,AOint,dims)

end #function rhf

function core(mol,sett,AOint,dims)
